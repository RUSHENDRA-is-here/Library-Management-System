...
icon = PhotoImage(file=os.path.join(BASE_DIR, "logo.png"))
window.iconphoto(True, icon)

frame = Frame(window)
frame.place(relx=0.015, rely=0.015)

img = ImageTk.PhotoImage(Image.open(os.path.join(BASE_DIR, "books_lib.jpg")))
...
def Addbook():
    ...
    submitbtn.grid(row=3, column=0, columnspan=2, ipadx=100, padx=10, pady=5)

    cancelbtn = Button(Newwin, text="Cancel", command=cancel)
    cancelbtn.grid(row=4, column=0, columnspan=2, ipadx=100, padx=10, pady=5)
...
def Updatebook():
    ...
    submitbtn = Button(Newwin, text="Submit", command=submit)
    submitbtn.grid(row=4, column=0, columnspan=2, ipadx=100, padx=10, pady=10)

    cancelbtn = Button(Newwin, text="Cancel", command=cancel)
    cancelbtn.grid(row=5, column=0, columnspan=2, ipadx=100, padx=10, pady=10)
...
def Issuebook():
    ...
    def submit():
        ...
        c.execute("""INSERT INTO books_issued (Title_of_Book, Student_Name,
                Issued_Date, Phone, Address) VALUES (:tob, :sn, :isd, :ph, :ad)""",
...
def Deletebook():
    ...
    delete_button = Button(Newwin, text='Delete', height=1, width=10, command=deleterecord)
    delete_button.grid(row=1, column=0, columnspan=2, ipadx=100, padx=10, pady=5)
    cancel_button = Button(Newwin, text='Cancel', height=1, width=10, command=canceldelete)
    cancel_button.grid(row=2, column=0, columnspan=2, ipadx=100, padx=10, pady=5)
    delete_all_button = Button(Newwin, text='Delete All records', height=1, width=10, command=deleteall)
    delete_all_button.grid(row=3, column=0, columnspan=2, ipadx=100, padx=10, pady=5)

titleLabel = Label(window, text="Welcome to \nLibrary Management System", font=("Arial", 20, "bold"))
titleLabel.pack(padx=20, pady=45)

Addbutton = Button(window, text="Add books", height=2, width=30, command=Addbook, font=("ComicSans", 12, "bold"))
Addbutton.pack(padx=10, pady=10)
Viewbutton = Button(window, text="View Books", height=2, width=30, command=Viewbook, font=("ComicSans", 12, "bold"))
Viewbutton.pack(padx=10, pady=10)
Updatebutton = Button(window, text="Update Books", height=2, width=30, command=Updatebook, font=("ComicSans", 12, "bold"))
Updatebutton.pack(padx=10, pady=10)
Issuebutton = Button(window, text="Issue Books", height=2, width=30, command=Issuebook, font=("ComicSans", 12, "bold"))
Issuebutton.pack(padx=10, pady=10)
Returnbutton = Button(window, text="Return Books", height=2, width=30, command=Returnbook, font=("ComicSans", 12, "bold"))
Returnbutton.pack(padx=10, pady=10)
Deletebutton = Button(window, text="Delete Books", height=2, width=30, command=Deletebook, font=("ComicSans", 12, "bold"))
Deletebutton.pack(padx=10, pady=10)
Quitbutton = Button(window, text="Quit", height=2, width=30, command=window.destroy, font=("ComicSans", 12, "bold"))
